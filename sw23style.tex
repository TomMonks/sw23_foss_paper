...
% ***********
% Adopted and modified by A. Anagnostou for the SW18
% ***********
%
...
\begin{filecontents*}{swpaperproc.cls}
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{filecontents*}{swsetup.sty}
%*******************************************************************************
%*
...
\def\currentYear {2023}               % EDITOR: update with current year
\def\currentEditors {\editors2023} % EDITOR: update by current editor definition macro
\def\currentCaption {Proceedings of the Operational Research Society Simulation Workshop \currentYear{} (SW23)}
...
\begin{filecontents*}{sw.sty}
%*******************************************************************************
%*
%* ***SW Style File adopted from WSC Style File - Base for LaTeX Papers for the WinterSim ***
%*
...
%\RequirePackage[nofoot,a4paper,lmargin=1in,tmargin=1in,rmargin=1in,bmargin=1in]{geometry}

%\setlength\footskip{75\p@}

\setlength\textwidth{6.267in}

%new for WSC-10
\setlength\textheight{9.69in} %9.0125in
\headsep=12pt
...
\input{swbib.tex}           % Set up BiBTeX macros
...
\begin{filecontents*}{swbib.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                            %
%                          Adopted from WSC.BST                              %
%        THESE COMMANDS ARE REQUIRED TO WORK WITH SW.BST TO MAKE BIBLIO     %
%                                                                            %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\makeatletter
\let\@internalcite\cite
